...
void affichage(unsigned int adresse, unsigned int data);
void RTC_Send(int adresse, int regis ,int data);
int RTC_Recieve(int adresse, int regis);
char Init_RTC (char secondes, char minutes, char heures, char jour, char mois, char annee);
void Read_RTC(char Tab[6]);
char min10(char data);
char min60(char data);
...
void main(void) 
{
    ...
    int adresses[4] = {0b01000010, 0b01000110, 0b01000000, 0b01001110};
    ...
    while(1)
    {
        ...
        affichage(adresses[3], pos_segment[min10(Tab[5])]);
        affichage(adresses[2], pos_segment[min60(Tab[5])]);
        affichage(adresses[1], pos_segment[min10(Tab[4])]);
        affichage(adresses[0], pos_segment[min60(Tab[4])]);
