...
void comp_Start();
 void comp_Stop();
 void comp_adress_sending(char adresse);
 void comp_registre_sending(char regis);
 void comp_data_sending(char data);
...
{ 
     comp_Start();
     comp_adress_sending(adresse);
     comp_data_sending(data);
     comp_Stop();
}
...
{ 
    comp_Start();
    comp_adress_sending(adresse & 0b11111110);
    comp_registre_sending(regis);
    ...
    comp_adress_sending((adresse & 0b11111110) + 1);
