...
void main(void) {
    ...
    */
    ...
    while(1){
        ...
        sendData7Seg(Seg[2],pos_segment[readEEPROM(0)-48]);
        sendData7Seg(Seg[0],pos_segment[readEEPROM(1)-48]);
...
void writeEEPROM(char address, char data){
    ...
    EECON1bits.EEPGD = 0;
    EECON1bits.WREN = 1;
    // INTCON.GIE = 0    // si elles sont active
    EECON2 = 0x55;
    EECON2 = 0xAA;
    EECON1bits.WR = 1;
    // INTCON.GIE = 1    // si elles sont active
    EECON1bits.WREN = 0;   
}
